...
extension ASCII {
    ...
    /// A string of up to three characters representing the value. Unprintables are represented by their abbreviation. Values > 0x7F are represented by a dot.
